...
<div class="row mb-1">
    <div class="col-8">
        <h2 class="content-header-title float-left mb-0">Deposit History</h2>
    </div>
</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @php
                                    $totalDeposit=0;
                                @endphp
                                @foreach($depositHistory as $transaction)
                                @php
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="4" class="text-right">Total Deposit:</th>
                                    <th class="text-right" colspan="2">{{number_format($totalDeposit,2)}}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
